                        ...
                        <form method="POST" action="/product">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="cost_of_goods" step="0.01" class="form-control" id="exampleInputPassword1"
                                        placeholder="Cost of goods">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Sale price</label>
                                    <input type="number" name="sale_price" step="0.01" class="form-control" id="exampleInputPassword1"
