            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <form action="/warehouse/" method="POST" class="mx-3">
                                @csrf
                                <div class="form-group">
                                    <label>Add warehouse</label>
                                    <input type="text" placeholder="warehouse name" name="name" class="form-control">
                                </div>
                                <button style="float: right;" type="submit" class="btn btn-primary">Add Warehouse</button>
                            </form>
                            @if (session('message'))
                                <ul>
                                        ...
                                        @foreach ($warehouses as $warehouse)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="modal fade .modal-xl" id="editModal{{ $warehouse->id }}"
